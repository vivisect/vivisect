...
ppc_ops = (
	...
	( "msync"      , 0x7C0004AC, 0x7C0004AC | F_MASK_XFX ,  F_NONE, (TYPE_NONE, TYPE_NONE, TYPE_NONE, TYPE_NONE, TYPE_NONE)),
	...
	( "stwx"       , 0x7C00012E, 0x7C00012E | F_MASK_XO  ,   F_XO , (TYPE_REG, TYPE_REG, TYPE_REG, TYPE_NONE, TYPE_NONE)),
	( "mfcr"       , 0x7C000026, 0x7C000026 | F_MASK_XO  ,   F_XO , (TYPE_REG, TYPE_NONE, TYPE_NONE, TYPE_NONE, TYPE_NONE)),
	( "mtcrf"      , 0x7C000120, 0x7C000120 | F_MASK_XO  ,   F_XO , (TYPE_REG, TYPE_IMM, TYPE_NONE, TYPE_NONE, TYPE_NONE)), #crf rossz
...
se_ops = (
	...
	( "se_sub"    , 0x0600, 0x06FF, 2, ((0x00F0,  4,  0,  0, 1, TYPE_REG), (0x000F,  0,  0,  0,  0, TYPE_REG), (0), (0), (0))),
	( "se_subf"   , 0x0700, 0x07FF, 2, ((0x00F0,  4,  0,  0, 1, TYPE_REG), (0x000F,  0,  0,  0,  0, TYPE_REG), (0), (0), (0))),
	...
	( "se_slw"    , 0x4200, 0x42FF, 2, ((0x00F0,  4,  0,  0, 1, TYPE_REG), (0x000F,  0,  0,  0,  0, TYPE_REG), (0), (0), (0))),
	( "se_slwi"   , 0x6C00, 0x6DFF, 2, ((0x01F0,  4,  0,  0, 1, TYPE_IMM), (0x000F,  0,  0,  0,  0, TYPE_REG), (0), (0), (0))),
	( "se_sraw"   , 0x4100, 0x41FF, 2, ((0x00F0,  4,  0,  0, 1, TYPE_REG), (0x000F,  0,  0,  0,  0, TYPE_REG), (0), (0), (0))),
	( "se_srawi"  , 0x6A00, 0x6BFF, 2, ((0x01F0,  4,  0,  0, 1, TYPE_IMM), (0x000F,  0,  0,  0,  0, TYPE_REG), (0), (0), (0))),
	( "se_srw"    , 0x4000, 0x40FF, 2, ((0x00F0,  4,  0,  0, 1, TYPE_REG), (0x000F,  0,  0,  0,  0, TYPE_REG), (0), (0), (0))),
