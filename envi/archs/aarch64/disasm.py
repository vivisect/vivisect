...
class A64SysRegOper(A64RegOper):
    ...
    def __init__(self, op0, op1, crn, crm, op2, va=0, oflags=0, size=8):

        self.encoding = (1 << 15) | (op0 << 14) | (op1 << 11) | (crn << 7) | (crm << 3) | (op2)
        reg = sysregnamedic.get(self.encoding)
    ...
    def render(self, mcanv, op, idx):
        # Check for non-standard name
        if self.reg is None:
            regrepr = 's' + str(op0) + '_' + str(op1) + '_c' + str(crn) + '_c' + str(crm) + '_' + str(op2)
...
sysregnamedic = {
    	32770: REG_OSDTRRX_EL1,
        32772: REG_DBGBVR0_EL1,
        32773: REG_DBGBCR0_EL1,
        32774: REG_DBGWVR0_EL1,
        32775: REG_DBGWCR0_EL1,
        32780: REG_DBGBVR1_EL1,
        32781: REG_DBGBCR1_EL1,
        32782: REG_DBGWVR1_EL1,
        32783: REG_DBGWCR1_EL1,
        32784: REG_MDCCINT_EL1,
        32786: REG_MDSCR_EL1,
        32788: REG_DBGBVR2_EL1,
        32789: REG_DBGBCR2_EL1,
        32790: REG_DBGWVR2_EL1,
        32791: REG_DBGWCR2_EL1,
        32794: REG_OSDTRTX_EL1,
        32796: REG_DBGBVR3_EL1,
        32797: REG_DBGBCR3_EL1,
        32798: REG_DBGWVR3_EL1,
        32799: REG_DBGWCR3_EL1,
        32804: REG_DBGBVR4_EL1,
        32805: REG_DBGBCR4_EL1,
        32806: REG_DBGWVR4_EL1,
        32807: REG_DBGWCR4_EL1,
        32812: REG_DBGBVR5_EL1,
        32813: REG_DBGBCR5_EL1,
        32814: REG_DBGWVR5_EL1,
        32815: REG_DBGWCR5_EL1,
        32818: REG_OSECCR_EL1,
        32820: REG_DBGBVR6_EL1,
        32821: REG_DBGBCR6_EL1,
        32822: REG_DBGWVR6_EL1,
        32823: REG_DBGWCR6_EL1,
        32828: REG_DBGBVR7_EL1,
        32829: REG_DBGBCR7_EL1,
        32830: REG_DBGWVR7_EL1,
        32831: REG_DBGWCR7_EL1,
        32836: REG_DBGBVR8_EL1,
        32837: REG_DBGBCR8_EL1,
        32838: REG_DBGWVR8_EL1,
        32839: REG_DBGWCR8_EL1,
        32844: REG_DBGBVR9_EL1,
        32845: REG_DBGBCR9_EL1,
        32846: REG_DBGWVR9_EL1,
        32847: REG_DBGWCR9_EL1,
        32852: REG_DBGBVR10_EL1,
        32853: REG_DBGBCR10_EL1,
        32854: REG_DBGWVR10_EL1,
        32855: REG_DBGWCR10_EL1,
        32860: REG_DBGBVR11_EL1,
        32861: REG_DBGBCR11_EL1,
        32862: REG_DBGWVR11_EL1,
        32863: REG_DBGWCR11_EL1,
        32868: REG_DBGBVR12_EL1,
        32869: REG_DBGBCR12_EL1,
        32870: REG_DBGWVR12_EL1,
        32871: REG_DBGWCR12_EL1,
        32876: REG_DBGBVR13_EL1,
        32877: REG_DBGBCR13_EL1,
        32878: REG_DBGWVR13_EL1,
        32879: REG_DBGWCR13_EL1,
        32884: REG_DBGBVR14_EL1,
        32885: REG_DBGBCR14_EL1,
        32886: REG_DBGWVR14_EL1,
        32887: REG_DBGWCR14_EL1,
        32892: REG_DBGBVR15_EL1,
        32893: REG_DBGBCR15_EL1,
        32894: REG_DBGWVR15_EL1,
        32895: REG_DBGWCR15_EL1,
        32900: REG_OSLAR_EL1,
        32924: REG_OSDLR_EL1,
        32932: REG_DBGPRCR_EL1,
        33734: REG_DBGCLAIMSET_EL1,
        33742: REG_DBGCLAIMCLR_EL1,
        34817: REG_TRCTRACEIDR,
        34818: REG_TRCVICTLR,
        34820: REG_TRCSEQEVR0,
        34821: REG_TRCCNTRLDVR0,
        34823: REG_TRCIMSPEC0,
        34824: REG_TRCPRGCTLR,
        34825: REG_TRCQCTLR,
        34826: REG_TRCVIIECTLR,
        34828: REG_TRCSEQEVR1,
        34829: REG_TRCCNTRLDVR1,
        34831: REG_TRCIMSPEC1,
        34832: REG_TRCPROCSELR,
        34834: REG_TRCVISSCTLR,
        34836: REG_TRCSEQEVR2,
        34837: REG_TRCCNTRLDVR2,
        34839: REG_TRCIMSPEC2,
        34842: REG_TRCVIPCSSCTLR,
        34845: REG_TRCCNTRLDVR3,
        34847: REG_TRCIMSPEC3,
        34848: REG_TRCCONFIGR,
        34853: REG_TRCCNTCTLR0,
        34855: REG_TRCIMSPEC4,
        34861: REG_TRCCNTCTLR1,
        34863: REG_TRCIMSPEC5,
        34864: REG_TRCAUXCTLR,
        34868: REG_TRCSEQRSTEVR,
        34869: REG_TRCCNTCTLR2,
        34871: REG_TRCIMSPEC6,
        34876: REG_TRCSEQSTR,
        34877: REG_TRCCNTCTLR3,
        34879: REG_TRCIMSPEC7,
        34880: REG_TRCEVENTCTL0R,
        34882: REG_TRCVDCTLR,
        34884: REG_TRCEXTINSELR,
        34885: REG_TRCCNTVR0,
        34888: REG_TRCEVENTCTL1R,
        34890: REG_TRCVDSACCTLR,
        34892: REG_TRCEXTINSELR1,
        34893: REG_TRCCNTVR1,
        34896: REG_TRCRSR,
        34898: REG_TRCVDARCCTLR,
        34900: REG_TRCEXTINSELR2,
        34901: REG_TRCCNTVR2,
        34904: REG_TRCSTALLCTLR,
        34908: REG_TRCEXTINSELR3,
        34909: REG_TRCCNTVR3,
        34912: REG_TRCTSCTLR,
        34920: REG_TRCSYNCPR,
        34928: REG_TRCCCCTLR,
        34936: REG_TRCBBCTLR,
        34945: REG_TRCRSCTLR16,
        34946: REG_TRCSSCCR0,
        34947: REG_TRCSSPCICR0,
        34948: REG_TRCOSLAR,
        34953: REG_TRCRSCTLR17,
        34954: REG_TRCSSCCR1,
        34955: REG_TRCSSPCICR1,
        34960: REG_TRCRSCTLR2,
        34961: REG_TRCRSCTLR18,
        34962: REG_TRCSSCCR2,
        34963: REG_TRCSSPCICR2,
        34968: REG_TRCRSCTLR3,
        34969: REG_TRCRSCTLR19,
        34970: REG_TRCSSCCR3,
        34971: REG_TRCSSPCICR3,
        34976: REG_TRCRSCTLR4,
        34977: REG_TRCRSCTLR20,
        34978: REG_TRCSSCCR4,
        34979: REG_TRCSSPCICR4,
        34980: REG_TRCPDCR,
        34984: REG_TRCRSCTLR5,
        34985: REG_TRCRSCTLR21,
        34986: REG_TRCSSCCR5,
        34987: REG_TRCSSPCICR5,
        34992: REG_TRCRSCTLR6,
        34993: REG_TRCRSCTLR22,
        34994: REG_TRCSSCCR6,
        34995: REG_TRCSSPCICR6,
        35000: REG_TRCRSCTLR7,
        35001: REG_TRCRSCTLR23,
        35002: REG_TRCSSCCR7,
        35003: REG_TRCSSPCICR7,
        35008: REG_TRCRSCTLR8,
        35009: REG_TRCRSCTLR24,
        35010: REG_TRCSSCSR0,
        35016: REG_TRCRSCTLR9,
        35017: REG_TRCRSCTLR25,
        35018: REG_TRCSSCSR1,
        35024: REG_TRCRSCTLR10,
        35025: REG_TRCRSCTLR26,
        35026: REG_TRCSSCSR2,
        35032: REG_TRCRSCTLR11,
        35033: REG_TRCRSCTLR27,
        35034: REG_TRCSSCSR3,
        35040: REG_TRCRSCTLR12,
        35041: REG_TRCRSCTLR28,
        35042: REG_TRCSSCSR4,
        35048: REG_TRCRSCTLR13,
        35049: REG_TRCRSCTLR29,
        35050: REG_TRCSSCSR5,
        35056: REG_TRCRSCTLR14,
        35057: REG_TRCRSCTLR30,
        35058: REG_TRCSSCSR6,
        35064: REG_TRCRSCTLR15,
        35065: REG_TRCRSCTLR31,
        35066: REG_TRCSSCSR7,
        35072: REG_TRCACVR0,
        35073: REG_TRCACVR8,
        35074: REG_TRCACATR0,
        ...
        35121: REG_TRCACVR11,
        35122: REG_TRCACATR3,
        35123: REG_TRCACATR11,
        35136: REG_TRCACVR4,
        35137: REG_TRCACVR12,
        35138: REG_TRCACATR4,
        35139: REG_TRCACATR12,
        35140: REG_TRCDVCVR2,
        35141: REG_TRCDVCVR6,
        35142: REG_TRCDVCMR2,
        35143: REG_TRCDVCMR6,
        ...
        35153: REG_TRCACVR13,
        35154: REG_TRCACATR5,
        35155: REG_TRCACATR13,
        35168: REG_TRCACVR6,
        35169: REG_TRCACVR14,
        35170: REG_TRCACATR6,
        35171: REG_TRCACATR14,
        35172: REG_TRCDVCVR3,
        35173: REG_TRCDVCVR7,
        35174: REG_TRCDVCMR3,
        35175: REG_TRCDVCMR7,
        ...
        35185: REG_TRCACVR15,
        35186: REG_TRCACATR7,
        35187: REG_TRCACATR15,
        35200: REG_TRCCIDCVR0,
        35201: REG_TRCVMIDCVR0,
        35202: REG_TRCCIDCCTLR0,
        35210: REG_TRCCIDCCTLR1,
        35216: REG_TRCCIDCVR1,
        35217: REG_TRCVMIDCVR1,
        35218: REG_TRCVMIDCCTLR0,
        35226: REG_TRCVMIDCCTLR1,
        35232: REG_TRCCIDCVR2,
        35233: REG_TRCVMIDCVR2,
        35248: REG_TRCCIDCVR3,
        35249: REG_TRCVMIDCVR3,
        35264: REG_TRCCIDCVR4,
        35265: REG_TRCVMIDCVR4,
        35280: REG_TRCCIDCVR5,
        35281: REG_TRCVMIDCVR5,
        35296: REG_TRCCIDCVR6,
        35297: REG_TRCVMIDCVR6,
        35312: REG_TRCCIDCVR7,
        35313: REG_TRCVMIDCVR7,
        35716: REG_TRCITCTRL,
        35782: REG_TRCCLAIMSET,
        35790: REG_TRCCLAIMCLR,
        35814: REG_TRCLAR,
        36864: REG_TEECR32_EL1,
        36992: REG_TEEHBR32_EL1,
        38944: REG_DBGDTR_EL0,
        38952: REG_DBGDTRTX_EL0,
        41016: REG_DBGVCR32_EL2,
        49280: REG_SCTLR_EL1,
        49281: REG_ACTLR_EL1,
        49282: REG_CPACR_EL1,
        49285: REG_RGSR_EL1,
        ...
        49409: REG_TTBR1_EL1,
        49410: REG_TCR_EL1,
        49416: REG_APIAKEYLO_EL1,
        49417: REG_APIAKEYHI_EL1,
        49418: REG_APIBKEYLO_EL1,
        49419: REG_APIBKEYHI_EL1,
        49424: REG_APDAKEYLO_EL1,
        49425: REG_APDAKEYHI_EL1,
        49426: REG_APDBKEYLO_EL1,
        49427: REG_APDBKEYHI_EL1,
        49432: REG_APGAKEYLO_EL1,
        49433: REG_APGAKEYHI_EL1,
        49664: REG_SPSR_EL1,
        49665: REG_ELR_EL1,
        49672: REG_SP_EL0,
        49680: REG_SPSEL,
        ...
        49683: REG_PAN,
        49684: REG_UAO,
        49712: REG_ICC_PMR_EL1,
        49800: REG_AFSR0_EL1,
        49801: REG_AFSR1_EL1,
        49808: REG_ESR_EL1,
        49817: REG_ERRSELR_EL1,
        49825: REG_ERXCTLR_EL1,
        49826: REG_ERXSTATUS_EL1,
        49827: REG_ERXADDR_EL1,
        49829: REG_ERXPFGCTL_EL1,
        49830: REG_ERXPFGCDN_EL1,
        49832: REG_ERXMISC0_EL1,
        49833: REG_ERXMISC1_EL1,
        49834: REG_ERXMISC2_EL1,
        49835: REG_ERXMISC3_EL1,
        49839: REG_ERXTS_EL1,
        49840: REG_TFSR_EL1,
        49841: REG_TFSRE0_EL1,
        49920: REG_FAR_EL1,
        50080: REG_PAR_EL1,
        50376: REG_PMSCR_EL1,
        50378: REG_PMSICR_EL1,
        50379: REG_PMSIRR_EL1,
        50380: REG_PMSFCR_EL1,
        50381: REG_PMSEVFR_EL1,
        50382: REG_PMSLATFR_EL1,
        50383: REG_PMSIDR_EL1,
        50384: REG_PMBLIMITR_EL1,
        50385: REG_PMBPTR_EL1,
        50387: REG_PMBSR_EL1,
        50391: REG_PMBIDR_EL1,
        50392: REG_TRBLIMITR_EL1,
        50393: REG_TRBPTR_EL1,
        50394: REG_TRBBASER_EL1,
        50395: REG_TRBSR_EL1,
        50396: REG_TRBMAR_EL1,
        50398: REG_TRBTRG_EL1,
        50417: REG_PMINTENSET_EL1,
        50418: REG_PMINTENCLR_EL1,
        50422: REG_PMMIR_EL1,
        50448: REG_MAIR_EL1,
        50456: REG_AMAIR_EL1,
        50464: REG_LORSA_EL1,
        ...
        50690: REG_RMR_EL1,
        50697: REG_DISR_EL1,
        50753: REG_ICC_EOIR0_EL1,
        50755: REG_ICC_BPR0_EL1,
        50756: REG_ICC_AP0R0_EL1,
        50757: REG_ICC_AP0R1_EL1,
        50758: REG_ICC_AP0R2_EL1,
        50759: REG_ICC_AP0R3_EL1,
        50760: REG_ICC_AP1R0_EL1,
        50761: REG_ICC_AP1R1_EL1,
        50762: REG_ICC_AP1R2_EL1,
        50763: REG_ICC_AP1R3_EL1,
        50777: REG_ICC_DIR_EL1,
        50781: REG_ICC_SGI1R_EL1,
        50782: REG_ICC_ASGI1R_EL1,
        50783: REG_ICC_SGI0R_EL1,
        50785: REG_ICC_EOIR1_EL1,
        50787: REG_ICC_BPR1_EL1,
        50788: REG_ICC_CTLR_EL1,
        50789: REG_ICC_SRE_EL1,
        50790: REG_ICC_IGRPEN0_EL1,
        50791: REG_ICC_IGRPEN1_EL1,
        50792: REG_ICC_SEIEN_EL1,
        50817: REG_CONTEXTIDR_EL1,
        50820: REG_TPIDR_EL1,
        50823: REG_SCXTNUM_EL1,
        50952: REG_CNTKCTL_EL1,
        53248: REG_CSSELR_EL1,
        55824: REG_NZCV,
        55825: REG_DAIFSET,
        55829: REG_DIT,
        55830: REG_SSBS,
        ...
        55849: REG_DLR_EL0,
        56544: REG_PMCR_EL0,
        56545: REG_PMCNTENSET_EL0,
        56546: REG_PMCNTENCLR_EL0,
        56547: REG_PMOVSCLR_EL0,
        56548: REG_PMSWINC_EL0,
        56549: REG_PMSELR_EL0,
        56552: REG_PMCCNTR_EL0,
        56553: REG_PMXEVTYPER_EL0,
        56554: REG_PMXEVCNTR_EL0,
        56557: REG_DAIFCLR,
        56560: REG_PMUSERENR_EL0,
        56563: REG_PMOVSSET_EL0,
        56962: REG_TPIDR_EL0,
        56963: REG_TPIDRRO_EL0,
        56967: REG_SCXTNUM_EL0,
        56976: REG_AMCR_EL0,
        56979: REG_AMUSERENR_EL0,
        56980: REG_AMCNTENCLR0_EL0,
        56981: REG_AMCNTENSET0_EL0,
        56984: REG_AMCNTENCLR1_EL0,
        56985: REG_AMCNTENSET1_EL0,
        56992: REG_AMEVCNTR00_EL0,
        56993: REG_AMEVCNTR01_EL0,
        56994: REG_AMEVCNTR02_EL0,
        56995: REG_AMEVCNTR03_EL0,
        57056: REG_AMEVCNTR10_EL0,
        57057: REG_AMEVCNTR11_EL0,
        57058: REG_AMEVCNTR12_EL0,
        57059: REG_AMEVCNTR13_EL0,
        57060: REG_AMEVCNTR14_EL0,
        57061: REG_AMEVCNTR15_EL0,
        57062: REG_AMEVCNTR16_EL0,
        57063: REG_AMEVCNTR17_EL0,
        57064: REG_AMEVCNTR18_EL0,
        57065: REG_AMEVCNTR19_EL0,
        57066: REG_AMEVCNTR110_EL0,
        57067: REG_AMEVCNTR111_EL0,
        57068: REG_AMEVCNTR112_EL0,
        57069: REG_AMEVCNTR113_EL0,
        57070: REG_AMEVCNTR114_EL0,
        57071: REG_AMEVCNTR115_EL0,
        57072: REG_AMEVTYPER10_EL0,
        57073: REG_AMEVTYPER11_EL0,
        57074: REG_AMEVTYPER12_EL0,
        57075: REG_AMEVTYPER13_EL0,
        57076: REG_AMEVTYPER14_EL0,
        57077: REG_AMEVTYPER15_EL0,
        57078: REG_AMEVTYPER16_EL0,
        57079: REG_AMEVTYPER17_EL0,
        57080: REG_AMEVTYPER18_EL0,
        57081: REG_AMEVTYPER19_EL0,
        57082: REG_AMEVTYPER110_EL0,
        57083: REG_AMEVTYPER111_EL0,
        57084: REG_AMEVTYPER112_EL0,
        57085: REG_AMEVTYPER113_EL0,
        57086: REG_AMEVTYPER114_EL0,
        57087: REG_AMEVTYPER115_EL0,
        57088: REG_CNTFRQ_EL0,
        57104: REG_CNTP_TVAL_EL0,
        57105: REG_CNTP_CTL_EL0,
        57106: REG_CNTP_CVAL_EL0,
        57112: REG_CNTV_TVAL_EL0,
        57113: REG_CNTV_CTL_EL0,
        57114: REG_CNTV_CVAL_EL0,
        57152: REG_PMEVCNTR0_EL0,
        57153: REG_PMEVCNTR1_EL0,
        57154: REG_PMEVCNTR2_EL0,
        57155: REG_PMEVCNTR3_EL0,
        57156: REG_PMEVCNTR4_EL0,
        57157: REG_PMEVCNTR5_EL0,
        57158: REG_PMEVCNTR6_EL0,
        57159: REG_PMEVCNTR7_EL0,
        57160: REG_PMEVCNTR8_EL0,
        57161: REG_PMEVCNTR9_EL0,
        57162: REG_PMEVCNTR10_EL0,
        57163: REG_PMEVCNTR11_EL0,
        57164: REG_PMEVCNTR12_EL0,
        57165: REG_PMEVCNTR13_EL0,
        57166: REG_PMEVCNTR14_EL0,
        57167: REG_PMEVCNTR15_EL0,
        57168: REG_PMEVCNTR16_EL0,
        57169: REG_PMEVCNTR17_EL0,
        57170: REG_PMEVCNTR18_EL0,
        57171: REG_PMEVCNTR19_EL0,
        57172: REG_PMEVCNTR20_EL0,
        57173: REG_PMEVCNTR21_EL0,
        57174: REG_PMEVCNTR22_EL0,
        57175: REG_PMEVCNTR23_EL0,
        57176: REG_PMEVCNTR24_EL0,
        57177: REG_PMEVCNTR25_EL0,
        57178: REG_PMEVCNTR26_EL0,
        57179: REG_PMEVCNTR27_EL0,
        57180: REG_PMEVCNTR28_EL0,
        57181: REG_PMEVCNTR29_EL0,
        57182: REG_PMEVCNTR30_EL0,
        57184: REG_PMEVTYPER0_EL0,
        57185: REG_PMEVTYPER1_EL0,
        57186: REG_PMEVTYPER2_EL0,
        57187: REG_PMEVTYPER3_EL0,
        57188: REG_PMEVTYPER4_EL0,
        57189: REG_PMEVTYPER5_EL0,
        57190: REG_PMEVTYPER6_EL0,
        57191: REG_PMEVTYPER7_EL0,
        57192: REG_PMEVTYPER8_EL0,
        57193: REG_PMEVTYPER9_EL0,
        57194: REG_PMEVTYPER10_EL0,
        57195: REG_PMEVTYPER11_EL0,
        57196: REG_PMEVTYPER12_EL0,
        57197: REG_PMEVTYPER13_EL0,
        57198: REG_PMEVTYPER14_EL0,
        57199: REG_PMEVTYPER15_EL0,
        57200: REG_PMEVTYPER16_EL0,
        57201: REG_PMEVTYPER17_EL0,
        57202: REG_PMEVTYPER18_EL0,
        57203: REG_PMEVTYPER19_EL0,
        57204: REG_PMEVTYPER20_EL0,
        57205: REG_PMEVTYPER21_EL0,
        57206: REG_PMEVTYPER22_EL0,
        57207: REG_PMEVTYPER23_EL0,
        57208: REG_PMEVTYPER24_EL0,
        57209: REG_PMEVTYPER25_EL0,
        57210: REG_PMEVTYPER26_EL0,
        57211: REG_PMEVTYPER27_EL0,
        57212: REG_PMEVTYPER28_EL0,
        57213: REG_PMEVTYPER29_EL0,
        57214: REG_PMEVTYPER30_EL0,
        57215: REG_PMCCFILTR_EL0,
        57344: REG_VPIDR_EL2,
        57349: REG_VMPIDR_EL2,
        57472: REG_SCTLR_EL2,
        57473: REG_ACTLR_EL2,
        57480: REG_HCR_EL2,
        57481: REG_MDCR_EL2,
        ...
        57610: REG_VTCR_EL2,
        57616: REG_VNCR_EL2,
        57648: REG_VSTTBR_EL2,
        57650: REG_VSTCR_EL2,
        57728: REG_DACR32_EL2,
        57856: REG_SPSR_EL2,
        57857: REG_ELR_EL2,
        57864: REG_SP_EL1,
        57880: REG_SPSR_IRQ,
        ...
        57882: REG_SPSR_UND,
        57883: REG_SPSR_FIQ,
        57985: REG_IFSR32_EL2,
        57992: REG_AFSR0_EL2,
        57993: REG_AFSR1_EL2,
        58000: REG_ESR_EL2,
        58003: REG_VSESR_EL2,
        58008: REG_FPEXC32_EL2,
        58032: REG_TFSR_EL2,
        58112: REG_FAR_EL2,
        58116: REG_HPFAR_EL2,
        58568: REG_PMSCR_EL2,
        58640: REG_MAIR_EL2,
        58648: REG_AMAIR_EL2,
        58656: REG_MPAMHCR_EL2,
        58657: REG_MPAMVPMV_EL2,
        58664: REG_MPAM2_EL2,
        58672: REG_MPAMVPM0_EL2,
        58673: REG_MPAMVPM1_EL2,
        58674: REG_MPAMVPM2_EL2,
        58675: REG_MPAMVPM3_EL2,
        58676: REG_MPAMVPM4_EL2,
        58677: REG_MPAMVPM5_EL2,
        58678: REG_MPAMVPM6_EL2,
        58679: REG_MPAMVPM7_EL2,
        58880: REG_VBAR_EL2,
        58882: REG_RMR_EL2,
        58889: REG_VDISR_EL2,
        58944: REG_ICH_AP0R0_EL2,
        58945: REG_ICH_AP0R1_EL2,
        58946: REG_ICH_AP0R2_EL2,
        58947: REG_ICH_AP0R3_EL2,
        58952: REG_ICH_AP1R0_EL2,
        58953: REG_ICH_AP1R1_EL2,
        58954: REG_ICH_AP1R2_EL2,
        58955: REG_ICH_AP1R3_EL2,
        58956: REG_ICH_VSEIR_EL2,
        58957: REG_ICC_SRE_EL2,
        58968: REG_ICH_HCR_EL2,
        58970: REG_ICH_MISR_EL2,
        58975: REG_ICH_VMCR_EL2,
        58976: REG_ICH_LR0_EL2,
        58977: REG_ICH_LR1_EL2,
        58978: REG_ICH_LR2_EL2,
        58979: REG_ICH_LR3_EL2,
        58980: REG_ICH_LR4_EL2,
        58981: REG_ICH_LR5_EL2,
        58982: REG_ICH_LR6_EL2,
        58983: REG_ICH_LR7_EL2,
        58984: REG_ICH_LR8_EL2,
        58985: REG_ICH_LR9_EL2,
        58986: REG_ICH_LR10_EL2,
        58987: REG_ICH_LR11_EL2,
        58988: REG_ICH_LR12_EL2,
        58989: REG_ICH_LR13_EL2,
        58990: REG_ICH_LR14_EL2,
        58991: REG_ICH_LR15_EL2,
        59009: REG_CONTEXTIDR_EL2,
        59010: REG_TPIDR_EL2,
        59015: REG_SCXTNUM_EL2,
        59139: REG_CNTVOFF_EL2,
        59144: REG_CNTHCTL_EL2,
        59152: REG_CNTHP_TVAL_EL2,
        59153: REG_CNTHP_CTL_EL2,
        59154: REG_CNTHP_CVAL_EL2,
        59160: REG_CNTHV_TVAL_EL2,
        59161: REG_CNTHV_CTL_EL2,
        59162: REG_CNTHV_CVAL_EL2,
        59168: REG_CNTHVS_TVAL_EL2,
        59169: REG_CNTHVS_CTL_EL2,
        59170: REG_CNTHVS_CVAL_EL2,
        59176: REG_CNTHPS_TVAL_EL2,
        59177: REG_CNTHPS_CTL_EL2,
        59178: REG_CNTHPS_CVAL_EL2,
        59520: REG_SCTLR_EL12,
        59522: REG_CPACR_EL12,
        59537: REG_TRFCR_EL12,
        59648: REG_TTBR0_EL12,
        59649: REG_TTBR1_EL12,
        59650: REG_TCR_EL12,
        59904: REG_SPSR_EL12,
        59905: REG_ELR_EL12,
        60040: REG_AFSR0_EL12,
        60041: REG_AFSR1_EL12,
        60048: REG_ESR_EL12,
        60080: REG_TFSR_EL12,
        60160: REG_FAR_EL12,
        60616: REG_PMSCR_EL12,
        60688: REG_MAIR_EL12,
        60696: REG_AMAIR_EL12,
        60712: REG_MPAM1_EL12,
        60928: REG_VBAR_EL12,
        61057: REG_CONTEXTIDR_EL12,
        61063: REG_SCXTNUM_EL12,
        61192: REG_CNTKCTL_EL12,
        61200: REG_CNTP_TVAL_EL02,
        61201: REG_CNTP_CTL_EL02,
        61202: REG_CNTP_CVAL_EL02,
        61208: REG_CNTV_TVAL_EL02,
        61209: REG_CNTV_CTL_EL02,
        61210: REG_CNTV_CVAL_EL02,
        61568: REG_SCTLR_EL3,
        61569: REG_ACTLR_EL3,
        61576: REG_SCR_EL3,
        61577: REG_SDER32_EL3,
        61578: REG_CPTR_EL3,
        61593: REG_MDCR_EL3,
        61696: REG_TTBR0_EL3,
        61698: REG_TCR_EL3,
        ...
        62976: REG_VBAR_EL3,
        62978: REG_RMR_EL3,
        63076: REG_ICC_CTLR_EL3,
        63077: REG_ICC_SRE_EL3,
        63079: REG_ICC_IGRPEN1_EL3,
        63106: REG_TPIDR_EL3,
        63111: REG_SCXTNUM_EL3,
        65296: REG_CNTPS_TVAL_EL1,
        65297: REG_CNTPS_CTL_EL1,
        65298: REG_CNTPS_CVAL_EL1,
        65299: REG_SPSEL,
}

# fill in the gaps (HACK)
for x in range(0x8000, 0x10000):
    if sysregnamedic.get(x):
        continue
    sysregnamedic[x] = len(sys_regs) + REGS_SYSTEM_REGS
    op0 = (x >> 14) & 1
    op1 = (x >> 11) & 7
    crn = (x >> 7) & 0xf
    crm = (x >> 3) & 0xf
    op2 = x & 7
    sys_regs.append(("s%d_%d_c%d_c%d_%d" % (op0, op1, crn, crm, op2), 64))
...
"""
ARM64 (AArch64) Disassembler - System Register Operand Updates
Add this to envi/archs/aarch64/disasm.py
"""
...
def _build_sysreg_lookup():
    ...
    # Count GPRs and SIMD regs to find where system regs start
    # GPRs: x0-x30, xzr, sp, pc = 34 registers
    # SIMD: v0-v31 = 32 registers
    # Total offset = 66
    base_idx = 0

    # Find the actual base by counting non-system registers
    for idx, (name, width) in enumerate(registers):
        # System registers start after all x* and v* registers
        if not (name.startswith('x') or name.startswith('v') or
                name in ('sp', 'pc', 'xzr')):
            base_idx = idx
            break

    # Now build the lookup from system register definitions
    for idx, (name, width) in enumerate(registers[base_idx:], start=base_idx):
...
class A64SysRegOper(envi.Operand):
    """
...
# Example usage in instruction emulation:
"""
# In the MRS instruction emulation:
def i_mrs(self, op):
    '''MRS: Move System Register to general-purpose register'''
    # op.opers[0] is destination register (GPR)
    # op.opers[1] is source system register (A64SysRegOper)

    sysreg_oper = op.opers[1]
    value = sysreg_oper.getOperValue(op, self)

    # Set destination register
    self.setOperValue(op.opers[0], op, value)

# In the MSR instruction emulation:
def i_msr(self, op):
    '''MSR: Move general-purpose register to System Register'''
    # op.opers[0] is destination system register (A64SysRegOper)
    # op.opers[1] is source register (GPR or immediate)

    value = self.getOperValue(op.opers[1], op)
