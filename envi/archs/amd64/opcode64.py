...
tbl32_660F[0x50] = (0, INS_MOV,     ADDRMETH_G | OPTYPE_y | OP_W, ADDRMETH_Z | OPTYPE_pd | OP_R, ARG_NONE, ARG_NONE, cpu_PENTIUM2, "movmskpd", 0, 0, 0)
...
# XXX: In an interesting case of asymmetry, neither of these are a thing. Nasm refuses to assemble them, that are no refs in the internet for them,
# nothing
