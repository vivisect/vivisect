...
tbl_fc = (\
    ...
    (None, FORM_RD_LD_RS, 0xfffc00, 0xfca400, INS_FTOU, 'ftou', ((O_RD, ((0, 0xf),)), (O_LDS, ((8, 0x3),)), (O_RS, ((4, 0xf),))), 3, IF_NONE),
    (None, FORM_RD_LD_RS, 0xfffc00, 0xfc9400, INS_FTOI, 'ftoi', ((O_RD, ((0, 0xf),)), (O_LDS, ((8, 0x3),)), (O_RS, ((4, 0xf),))), 3, IF_NONE),
    (None, FORM_RD_LD_RS, 0xfffc00, 0xfc8000, INS_FSUB, 'fsub', ((O_RD, ((0, 0xf),)), (O_LDS, ((8, 0x3),)), (O_RS, ((4, 0xf),))), 3, IF_NONE),
    ...
    (None, None, 0xfffc00, 0xfc6800, INS_BTST, 'btst', ((O_LDS, ((8, 0x3),)), (O_RS2, ((4, 0xf),)), (O_RS, ((0, 0xf),))), 3, IF_NONE),
    (None, FORM_RD_LD_RS, 0xfffc00, 0xfc6000, INS_BSET, 'bset', ((O_RD, ((4, 0xf),)), (O_LDD, ((8, 0x3),)), (O_RS, ((0, 0xf),))), 3, IF_NONE),
    (None, FORM_RD_LD_RS, 0xfffc00, 0xfc6000, INS_BSET, 'bset', ((O_RD, ((4, 0xf),)), (O_LDD, ((8, 0x3),)), (O_RS, ((0, 0xf),))), 3, IF_NONE),
    (None, FORM_RD_LD_RS, 0xfffc00, 0xfc6c00, INS_BNOT, 'bnot', ((O_RD, ((4, 0xf),)), (O_LDD, ((8, 0x3),)), (O_RS, ((0, 0xf),))), 3, IF_NONE),
    (None, FORM_RD_LD_RS, 0xfffc00, 0xfc6c00, INS_BNOT, 'bnot', ((O_RD, ((4, 0xf),)), (O_LDD, ((8, 0x3),)), (O_RS, ((0, 0xf),))), 3, IF_NONE),
...
tblmain = (\
    ...
    (None, FORM_PCDSP, 0xff000000, 0x4000000, INS_BRA, 'bra', ((O_PCDSP, ((0, 0xffffff),))), 4, IF_BRANCH | IF_NOFALL),
    (None, FORM_PCDSP, 0xff000000, 0x5000000, INS_BSR, 'bsr', ((O_PCDSP, ((0, 0xffffff),))), 4, IF_CALL),
    ...
    (None, None, 0xf8, 0x18, INS_BNZ, 'bnz', ((O_DSP, ((0, 0x7),))), 1, IF_BRANCH | IF_COND),
    (None, None, 0xf8, 0x18, INS_BNZ, 'bnz', ((O_DSP, ((0, 0x7),))), 1, IF_BRANCH | IF_COND),
    (None, FORM_PCDSP, 0xff00, 0x2000, INS_BZ, 'bz', ((O_PCDSP, ((0, 0xff),))), 2, IF_BRANCH | IF_COND),
    (None, FORM_PCDSP, 0xff00, 0x2100, INS_BNZ, 'bnz', ((O_PCDSP, ((0, 0xff),))), 2, IF_BRANCH | IF_COND),
    (None, FORM_PCDSP, 0xff00, 0x2200, INS_BGEU, 'bgeu', ((O_PCDSP, ((0, 0xff),))), 2, IF_BRANCH | IF_COND),
    (None, FORM_PCDSP, 0xff00, 0x2300, INS_BLTU, 'bltu', ((O_PCDSP, ((0, 0xff),))), 2, IF_BRANCH | IF_COND),
    (None, FORM_PCDSP, 0xff00, 0x2400, INS_BGTU, 'bgtu', ((O_PCDSP, ((0, 0xff),))), 2, IF_BRANCH | IF_COND),
    (None, FORM_PCDSP, 0xff00, 0x2500, INS_BLEU, 'bleu', ((O_PCDSP, ((0, 0xff),))), 2, IF_BRANCH | IF_COND),
    (None, FORM_PCDSP, 0xff00, 0x2600, INS_BPZ, 'bpz', ((O_PCDSP, ((0, 0xff),))), 2, IF_BRANCH | IF_COND),
    (None, FORM_PCDSP, 0xff00, 0x2700, INS_BN, 'bn', ((O_PCDSP, ((0, 0xff),))), 2, IF_BRANCH | IF_COND),
    (None, FORM_PCDSP, 0xff00, 0x2800, INS_BGE, 'bge', ((O_PCDSP, ((0, 0xff),))), 2, IF_BRANCH | IF_COND),
    (None, FORM_PCDSP, 0xff00, 0x2900, INS_BLT, 'blt', ((O_PCDSP, ((0, 0xff),))), 2, IF_BRANCH | IF_COND),
    (None, FORM_PCDSP, 0xff00, 0x2a00, INS_BGT, 'bgt', ((O_PCDSP, ((0, 0xff),))), 2, IF_BRANCH | IF_COND),
    (None, FORM_PCDSP, 0xff00, 0x2b00, INS_BLE, 'ble', ((O_PCDSP, ((0, 0xff),))), 2, IF_BRANCH | IF_COND),
    (None, FORM_PCDSP, 0xff00, 0x2c00, INS_BO, 'bo', ((O_PCDSP, ((0, 0xff),))), 2, IF_BRANCH | IF_COND),
    (None, FORM_PCDSP, 0xff00, 0x2d00, INS_BNO, 'bno', ((O_PCDSP, ((0, 0xff),))), 2, IF_BRANCH | IF_COND),
    (None, FORM_PCDSP, 0xff00, 0x2e00, INS_BRA, 'bra', ((O_PCDSP, ((0, 0xff),))), 2, IF_BRANCH | IF_NOFALL),
    None,
    None,
    None,
    None,
    ...
    None,
    None,
    (None, FORM_PCDSP, 0xff0000, 0x380000, INS_BRA, 'bra', ((O_PCDSP, ((0, 0xffff),))), 3, IF_BRANCH | IF_NOFALL),
    ...
    (None, FORM_RD_IMM, 0xff00, 0x6600, INS_MOV, 'mov', ((O_RD, ((0, 0xf),)), (O_IMM, ((4, 0xf),))), 2, IF_NONE),
