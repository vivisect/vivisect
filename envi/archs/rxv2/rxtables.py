...
tbl_fc = (\
    ...
    (None, None, 0xffff00, 0xfc4b00, INS_STNZ, 'stnz', ((O_RD, ((0, 0xf),)), (O_RS, ((4, 0xf),)), ), 3, IF_COND),
...
tblmain = (\
    ...
    (None, FORM_PCDSPA, 0xff000000, 0x4000000, INS_BRA, 'bra', ((O_PCDSP, ((0, 0xffffff),)), ), 4, IF_BRANCH | IF_NOFALL),
    (None, FORM_PCDSPA, 0xff000000, 0x5000000, INS_BSR, 'bsr', ((O_PCDSP, ((0, 0xffffff),)), ), 4, IF_CALL),
