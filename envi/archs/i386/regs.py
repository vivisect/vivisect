...
# Branch-trace-interrupt (gen interrupt on BTS full)
...
locs = locals()
e_reg.addLocalEnums(locs, i386regs)
...
e_reg.addLocalStatusMetas(locs, i386meta, statmetas, 'EFLAGS')
e_reg.addLocalMetas(locs, i386meta)
