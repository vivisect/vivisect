...
tbl32_660F3A[0x14] = (0, INS_OTHER, ADDRMETH_E | OPTYPE_b | OP_W, ADDRMETH_V | OPTYPE_dq | OP_R, ADDRMETH_I | OPTYPE_b | OP_R, cpu_PENTMMX, "pextrb", 0, 0, 0) # This is wrong on the first operand
