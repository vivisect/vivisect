...
instrs = [
        ...
        ( "1a03", 0x4560, 'dec.b r3h'),
        ( "1a83", 0x4560, 'sub.l er0, er3'),
        ( "1b83", 0x4560, 'subs #2, er3'),
        ( "1b93", 0x4560, 'subs #4, er3'),
        ( "1b53", 0x4560, 'dec.w #1, r3'),
        ( "1bf3", 0x4560, 'dec.l #2, er3'),
        ( "1f00", 0x4560, 'das r0h'),
        ( "1f93", 0x4560, 'cmp.l er1, er3'),
