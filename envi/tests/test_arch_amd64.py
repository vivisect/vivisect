...
amd64MultiByteOpcodes = [
    ...
    ('VMXON', 'f30fc73541414100', 0x40, 'vmxon qword [rip + 4276545]', 'vmxon qword [rip + 4276545]'),
    ('VMPTRST', '0FC73C2541414141', 0x40, 'vmptrst qword [0x41414141]', 'vmptrst qword [0x41414141]'),
    ('VMREAD', '0F78D8', 0x40, 'vmread rax,rbx', 'vmread rax,rbx'), #XXX: This will change on 32bit
    ('VMREAD 2', '0F781C2541414141', 0x40, 'vmread qword [0x41414141],rbx', 'vmread qword [0x41414141],rbx'),
    ('VMWRITE', '0F79CB', 0x40, 'vmwrite rcx,rbx', 'vmwrite rcx,rbx'),
    ('VMWRITE 2', '0F790C2541414141', 0x40, 'vmwrite rcx,qword [0x41414141]', 'vmwrite rcx,qword [0x41414141]'),
    ('VMXOFF', '0F01C4', 0x40, 'vmxoff ', 'vmxoff '),
    ('VMRESUME', '0F01C3', 0x40, 'vmresume ', 'vmresume '),
    ('VMLAUNCH', '0F01C2', 0x40, 'vmlaunch ', 'vmlaunch '),
    ('VMFUNC', '0F01D4', 0x40, 'vmfunc ', 'vmfunc '),  # XXX: Implies eax
    ('VMCALL', '0F01C1', 0x40, 'vmcall ', 'vmcall '),
    ('VMCLEAR', '660FC7342541414141', 0x40, 'vmclear qword [0x41414141]', 'vmclear qword [0x41414141]'),
    ('INVVPID', '660F3881042541414141', 0x40, 'invvpid rax,oword [0x41414141]', 'invvpid rax,oword [0x41414141]'),
    ('INVEPT', '660F3880142541414141', 0x40, 'invept rdx,oword [0x41414141]', 'invept rdx,oword [0x41414141]'),
    ('MULSD', 'f20f59c1', 0x40, 'mulsd xmm0,xmm1', 'mulsd xmm0,xmm1'),
    ('VMCLEAR', '660FC73541414100', 0x40, 'vmclear qword [rip + 4276545]', 'vmclear qword [rip + 4276545]'),
    ...
    ('MOVUPD', '660f1018', 0x40, 'movupd xmm3,oword [rax]', 'movupd xmm3,oword [rax]'),
    ('UNPCKLPD', '660F14A241414100', 0x40, 'unpcklpd xmm4,oword [rdx + 4276545]', 'unpcklpd xmm4,oword [rdx + 4276545]'),
