...
i386MultiByteOpcodes = [
    ...
    ('PEXTRB 2', '660F3A141011', 0x40, 'pextrb dword [eax],xmm2,17', 'pextrb dword [eax],xmm2,17'),
    ...
    ('MOVBE',   '0F38F04910', 0x40, 'movbe ecx,dword [edx + 16]', 'movbe ecx,dword [edx + 16]'),
    ...
    ('MOVBE 4', '0F38F15110', 0x40, 'movbe dword [edx + 16],eax', 'movbe dword [edx + 16],eax'),
