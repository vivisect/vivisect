...
instrs = [
        ...
        ('76341780', 0x4560, 'or 0x1780,r4', 0, ()),             # FORM_
        ('56341780', 0x4560, 'or 0x1780[r3].ub,r4', 0, ()),             # FORM_
        ('0696341780', 0x4560, 'or 0x1780[r3].l,r4', 0, ()),             # FORM_
        ('ff5234', 0x4560, 'or r3,r4,r2', 0, ()),             # FORM_
        ('7eb4', 0x4560, 'pop r4', 0, ()),             # FORM_
        ('7ee3', 0x4560, 'popc fpsw', 0, ()),             # FORM_
        ('7ea3', 0x4560, 'push.l r3', 0, ()),             # FORM_
        ('f63a1780', 0x4560, 'push.l 0x1780[r3]', 0, ()),             # FORM_
