...
def initWinkernTrace(trace, kpcrva):
    ...
    trace.vsbuilder.addVStructNamespace(
        'nt', vs_w_ntoskrnl)  # FIXME no remote!
    ...
    dbgdata64va = trace.readMemoryFormat(
        kver.DebuggerDataList & trace.bigmask, '<I')[0]
    ...
    while ldr_entry != modlist:
        ...
        try:
            ...
            print('Trouble while parsing one...%s' % e)
