...
api_64_adds = {
    'msvcr100.??2@yapeax_k@z':( 'int', None, 'cdecl', 'msvcr100.??2@YAPEAX_K@Z', (('int', None),) ),
    'msvcr100.??_u@yapeax_k@z':( 'int', None, 'cdecl', 'msvcr100.??_U@YAPEAX_K@Z', (('int', None),) ),
    'msvcr100.??3@yaxpeax@z':( 'void', None, 'cdecl', 'msvcr100.??3@YAXPEAX@Z', (('void *', 'ptr'),) ),
    'msvcr100.??_v@yaxpeax@z':( 'void', None, 'cdecl', 'msvcr100.??_V@YAXPEAX@Z', (('void *', 'ptr'),) ),
    }
