# APIs for Windows 64-bit MSVC 2010 runtime library (msvcr100).
...
api_32_omits = [
    'msvcr100.??2@yapaxi@z',
    'msvcr100.??_u@yapaxi@z',
    'msvcr100.??3@yaxpax@z',
    'msvcr100.??_v@yaxpax@z'
]

# Define any functions specific to 64-bit.
api_64_adds = {
    'msvcr100.??2@yapeax_k@z':( 'int', None, 'msx64call', 'msvcr100.??2@YAPEAX_K@Z', (('int', None),) ),
    'msvcr100.??_u@yapeax_k@z':( 'int', None, 'msx64call', 'msvcr100.??_U@YAPEAX_K@Z', (('int', None),) ),
    'msvcr100.??3@yaxpeax@z':( 'void', None, 'msx64call', 'msvcr100.??3@YAXPEAX@Z', (('void *', 'ptr'),) ),
    'msvcr100.??_v@yaxpeax@z':( 'void', None, 'msx64call', 'msvcr100.??_V@YAXPEAX@Z', (('void *', 'ptr'),) ),
    }
...
import vivisect.impapi.windows.msvcr100_32 as m32
