...
class VQDockWidget(vq_hotkeys.HotKeyMixin, QDockWidget):
    ...
    def __init__(self, parent):
        ...
        self.addHotKeyTarget('mem:undockmaximize',
                             self._hotkey_undock_maximize)
...
class VQMainCmdWindow(vq_hotkeys.HotKeyMixin, QMainWindow):
    ...
    def __init__(self, appname, cmd, **kwargs):
        ...
        self._vq_settings = QtCore.QSettings(
            'invisigoth', application=appname, parent=self)
        self._vq_histfile = os.path.join(
            os.path.expanduser('~'), '.%s_history' % appname)
