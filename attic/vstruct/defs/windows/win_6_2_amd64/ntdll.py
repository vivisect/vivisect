...
class KPRCB(vstruct.VStruct):
    def __init__(self):
        ...
        self.PrcbPad40 = vstruct.VArray([ v_uint32() for i in xrange(29) ])
        ...
        self.PrcbPad50 = vstruct.VArray([ v_uint8() for i in xrange(7) ])
        ...
        self.PrcbPad92 = vstruct.VArray([ v_uint32() for i in xrange(22) ])
        ...
        self.PrcbPad94 = vstruct.VArray([ v_uint64() for i in xrange(6) ])
