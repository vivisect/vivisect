...
class HIVE_LOAD_FAILURE(vstruct.VStruct):
    def __init__(self):
        ...
        self.Locations = vstruct.VArray([ _unnamed_28552() for i in xrange(8) ])
        self.RecoverableLocations = vstruct.VArray([ _unnamed_28552() for i in xrange(8) ])
...
class POP_POWER_ACTION(vstruct.VStruct):
    def __init__(self):
        ...
        self._pad0060 = v_bytes(size=4)
        self.WakeAlarm = vstruct.VArray([ _unnamed_34606() for i in xrange(3) ])
