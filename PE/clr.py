...
# CLR Type Attributes, shamelessly ripped from:
...
class CLRAssemblyFlags(enum.Enum):
    ...
    PA_NoPlatform         =   0x0070     # applies to any platform but cannot run on any (e.g. reference assembly), should not have "specified" set
...
class CLRSerializationTypes(enum.Enum):
    ...
    SERIALIZATION_TYPE_SZARRAY      = CLRSignatureElementTypes.ELEMENT_TYPE_SZARRAY # Shortcut for single dimension zero lower bound array
...
class CLRNativeTypes(enum.Enum):
    ...
    NATIVE_TYPE_VARIANTBOOL = 0x25   # (2-byte boolean value: TRUE = -1, FALSE = 0) COMINTEROP
    ...
    NATIVE_TYPE_ERROR       = 0x2d #  This native type coupled with ELEMENT_TYPE_I4 will map to VT_HRESULT COMINTEROP
...
class CLRSetEnv(enum.Enum):
    ...
    UpdateExtension           = 0x00000003   # Extension mode.  Tokens don't move, adds only.
...
class ErrorIfEmitOutOfOrder(enum.Enum):
    ...
    ErrorOutOfOrderAll        = 0xffffffff   # generate out of order emit for method, field, param, property, and event
    MethodOutOfOrder          = 0x00000001   # generate error when methods are emitted out of order
    ...
    PropertyOutOfOrder        = 0x00000008   # generate error when properties are emitted out of order
...
class CLRImportOptions(enum.Enum):
    ...
    ImportOptionAllTypeDefs   = 0x00000001       # all of the typedefs including the deleted typedef
    ImportOptionAllMethodDefs = 0x00000002       # all of the methoddefs including the deleted ones
    ImportOptionAllFieldDefs  = 0x00000004       # all of the fielddefs including the deleted ones
    ImportOptionAllProperties = 0x00000008       # all of the properties including the deleted ones
    ImportOptionAllEvents     = 0x00000010       # all of the events including the deleted ones
    ImportOptionAllCustomAttributes = 0x00000020 # all of the custom attributes including the deleted ones
    ImportOptionAllExportedTypes  = 0x00000040   # all of the ExportedTypes including the deleted ones
...
class CLRCoreOpenFlags(enum.Enum):
    ...
    NoTransform       =   0x00001000,     # Disable automatic transforms of .winmd files.
