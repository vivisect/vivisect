...
class ForceLayout(vg_layouts.GraphLayout):
    ...
    def setRandomLayout(self, graph):
        ...
        for nid, nprops in nodes:
            ...
            while rands.get(rpos):
                rpos = (self._f_randint(1, randmax),
                        self._f_randint(1, randmax))
    ...
    def _shiftGraphLayout(self, graph, dx, dy):
        ...
        [graph.setNodeProp(n, 'position', (n[1]['position']
                                           [0] + dx, n[1]['position'][1] + dy)) for n in nodes]
    ...
    def _tickPhysicsEngine(self, graph):
        ...
        for nid, nprops in nodes:
            ...
            [vadd(*repul(nprops, n2props))
             for (n2id, n2props) in nodes if n2id != nid]
