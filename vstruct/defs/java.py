...
class JavaClass(vstruct.VStruct):
    ...
    def getClassFields(self):
        ...
        for fname, fieldinfo in self.fields:
            ...
            fieldname = self.const_pool[fieldinfo.name_index -
                                        1].data.tagval.strbytes
            descname = self.const_pool[fieldinfo.descriptor_index -
                                       1].data.tagval.strbytes

            attrs = {}
            for afield, attrinfo in fieldinfo.attributes:
                attrname = self.const_pool[attrinfo.attribute_name_index -
                                           1].data.tagval.strbytes
    ...
    def getClassMethods(self):
        ...
        for fname, methinfo in self.methods:
            methname = self.const_pool[methinfo.name_index -
                                       1].data.tagval.strbytes
            attrs = {}
