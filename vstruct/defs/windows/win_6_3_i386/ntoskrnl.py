...
class POP_POWER_ACTION(vstruct.VStruct):
    def __init__(self):
        ...
        self.WakeAlarm = vstruct.VArray([ _unnamed_36207() for i in range(3) ])
...
class CM_DIRTY_VECTOR_LOG_ENTRY(vstruct.VStruct):
    def __init__(self):
        ...
        self.Stack = vstruct.VArray([ v_ptr32() for i in range(7) ])
...
class MMWSL(vstruct.VStruct):
    def __init__(self):
        ...
        self.ActiveWsleCounts = vstruct.VArray([ v_uint32() for i in range(16) ])
...
class MI_USER_VA_INFO(vstruct.VStruct):
    def __init__(self):
        ...
        self.CfgBitMap = vstruct.VArray([ MI_CFG_BITMAP_INFO() for i in range(1) ])
        self.CommittedPageTableBufferForTopLevel = vstruct.VArray([ v_uint32() for i in range(48) ])
        self.CommittedPageTableBitmaps = vstruct.VArray([ RTL_BITMAP() for i in range(1) ])
...
class HIVE_LOAD_FAILURE(vstruct.VStruct):
    def __init__(self):
        ...
        self.Locations = vstruct.VArray([ _unnamed_30217() for i in range(8) ])
        self.RecoverableLocations = vstruct.VArray([ _unnamed_30217() for i in range(8) ])
