...
class EPROCESS(vstruct.VStruct):
    def __init__(self):
        ...
        self.Spare0 = vstruct.VArray([ v_ptr32() for i in xrange(3) ])
...
class PCI_HEADER_TYPE_2(vstruct.VStruct):
    def __init__(self):
        ...
        self.Range = vstruct.VArray([ _unnamed_16653() for i in xrange(4) ])
...
class MM_SESSION_SPACE(vstruct.VStruct):
    def __init__(self):
        ...
        self.Lookaside = vstruct.VArray([ GENERAL_LOOKASIDE() for i in xrange(26) ])
...
class KPRCB(vstruct.VStruct):
    def __init__(self):
        ...
        self.LockQueue = vstruct.VArray([ KSPIN_LOCK_QUEUE() for i in xrange(33) ])
        ...
        self.SpareCounter1 = vstruct.VArray([ v_uint32() for i in xrange(8) ])
        ...
        self.PrcbPad5 = vstruct.VArray([ v_uint8() for i in xrange(18) ])
        self._pad099c = v_bytes(size=2)
        self.TickOffset = v_uint32()
        self.CallDpc = KDPC()
        self.PrcbPad7 = vstruct.VArray([ v_uint32() for i in xrange(8) ])
        self.WaitListHead = LIST_ENTRY()
        ...
        self.PrcbPad72 = vstruct.VArray([ v_uint32() for i in xrange(11) ])
        ...
        self.SpareFields0 = vstruct.VArray([ v_uint32() for i in xrange(1) ])
...
class TEB(vstruct.VStruct):
    def __init__(self):
        ...
        self.SpareBytes1 = vstruct.VArray([ v_uint8() for i in xrange(40) ])
        ...
        self.Instrumentation = vstruct.VArray([ v_ptr32() for i in xrange(14) ])
...
class MMPTE_FLUSH_LIST(vstruct.VStruct):
    def __init__(self):
        vstruct.VStruct.__init__(self)
        self.Count = v_uint32()
        self.FlushVa = vstruct.VArray([ v_ptr32() for i in xrange(33) ])
